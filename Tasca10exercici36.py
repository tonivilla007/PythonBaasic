"""
Modificar el següent programa per afegir un sistema de punts, és a dir, mentre el jugador guanyi,
anirà acumulant punts i en acabar o perdre se li mostrarà els punts aconseguits.
"""
import random
import time
